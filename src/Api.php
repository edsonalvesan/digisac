...
use EdsonAlvesan\DigiSac\Commands\CommandBus;
use EdsonAlvesan\DigiSac\Commands\CommandInterface;
...
class Api
{
    ...
    public function sendSticker(array $params)
    {
        if (is_file($params['sticker']) && (pathinfo($params['sticker'], PATHINFO_EXTENSION) !== 'webp')) {
            throw new DigiSacSDKException('Invalid Sticker Provided. Supported Format: Webp');
        }
    ...
    public function sendChatAction(array $params)
    {
        ...
        throw new DigiSacSDKException('Invalid Action! Accepted value: '.implode(', ', $validActions));
    }
    ...
    public function setWebhook(array $params)
    {
        if (filter_var($params['url'], FILTER_VALIDATE_URL) === false) {
            throw new DigiSacSDKException('Invalid URL Provided');
        }

        if (parse_url($params['url'], PHP_URL_SCHEME) !== 'https') {
            throw new DigiSacSDKException('Invalid URL, should be a HTTPS url.');
        }
