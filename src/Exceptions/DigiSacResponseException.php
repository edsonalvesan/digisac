...
{
    /**
     * @var DigiSacResponse The response that threw the exception.
     */
    protected $response;
    ...
    /**
     * Creates a DigiSacResponseException.
     *
     * @param DigiSacResponse     $response          The response that threw the exception.
     * @param DigiSacSDKException $previousException The more detailed exception.
     */
    public function __construct(DigiSacResponse $response, DigiSacSDKException $previousException = null)
    {
    ...
    public static function create(DigiSacResponse $response)
    {
        ...
        // Others
        return new static($response, new DigiSacOtherException($message, $code));
    }
